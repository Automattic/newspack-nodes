 ...
 * order 0 (first, before the Topology Manager at order 10). Importing the module
...
test( 'importing tabs registers the topology-console tab on the hub host at order 0', () => {
	const {
		getDevtoolsTabs,
		resetDevtoolsTabs,
