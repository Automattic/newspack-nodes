/**
 * Vault station-tab descriptor — every field of the tab except the
 ...
 * string alone and no `VaultAdmin` tree. The station would otherwise load on every
 ...
 * the tab on the station and off the debug overlay: every `Vault_CI` verb behind
