/**
 * topology-manager:view tests — the Topology Manager list model React reads via
 * useNodeState('topology-manager:view','view'). Stores the `topologies dump`
...
// A `topologies dump` reply as HttpOut delivers it: VALUE = { name, payload }.
function listReply( payload ) {
	const m = newMessage();
	m[ TYPE ] = TM_COMMAND | TM_RESPONSE;
	m[ VALUE ] = { name: 'dump', payload };
	return m;
}
