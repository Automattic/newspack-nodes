...
class Vault {
	 ...
	 * rotated password reconnects a healthy spoke with the old one. The option
	 * beneath the memo is fresh by then: a reload purges WordPress's option
	 * cache before `Config::reset()` fires the action.
	 */
